...
$queryProjek = mysqli_query($koneksi, "SELECT * FROM projek");
// mysqli_fetch_assoc($query) = untuk menjadikan hasil query menjadi sebuah data (object,array)
$rowProjek[''] = mysqli_fetch_assoc($queryProjek);
// jika parameter nya ada??delete=nilai parameter di url
if (isset($_GET['delete'])) {
    $id = $_GET['delete']; //mengambil nilai params
    // query / perintah hapus kolom tabel
    $deleteProjek = mysqli_query($koneksi, "DELETE FROM projek  WHERE id ='$id'");
    header("location:projek.php?hapus=berhasil");
}
?>
<!DOCTYPE html>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = ($rowProjek)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['total_projek'] ?></td>
                                                        <td>
