    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="komunitas.php" class="menu-link" target="_blank">
                        <div data-i18n="Basic">Data Komunitas</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-cube-alt"></i>
                <div data-i18n="Misc">Workspace</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="projek.php" class="menu-link" target="_blank">
                        <div data-i18n="Basic">Data Projek</div>
                    </a>
                </li>
            </ul>
        </li>
