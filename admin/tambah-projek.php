...
if (isset($_POST['simpan'])) {
    ...
    $total_projek    = $_POST['total_projek'];
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            $insertProjek = mysqli_query($koneksi, "INSERT INTO projek (nama_projek, total_projek, foto)
            VALUES ('$nama_projek', '$total_projek', '$nama_foto')");
        }
    } else {
        // tambah data tanpa foto komunitas
        $insertProjek = mysqli_query($koneksi, "INSERT INTO projek (nama_projek, total_projek, )
            VALUES ('$nama_projek', '$total_projek')");
    }

    header("location:projek.php?tambah=berhasil");
}
...
$queryEdit = mysqli_query($koneksi, "SELECT * FROM projek WHERE id ='$id'");
...
if (isset($_POST['edit'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            $update = mysqli_query($koneksi, "UPDATE projek SET nama_projek='$nama_projek', total_projek='$total_projek', foto='$nama_foto' WHERE id='$id'");
        }
    } else {
        // kalo user tidak ingin memasukkan gambar
        $update = mysqli_query($koneksi, "UPDATE projek SET nama_projek='$nama_projek', total_projek='$total_projek' WHERE id='$id'");
    }

    header("location:projek.php?ubah=berhasil");
}
?>
<!DOCTYPE html>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        required
                                                        value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_projek'] : '' ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="" class="form-label">Total Projek</label>
                                                    <input type="text"
                                                        class="form-control"
                                                        name="total_projek"
                                                        placeholder="Masukkan total projek"
                                                        required
                                                        value="<?php echo isset($_GET['edit']) ? $rowEdit['total_projek'] : '' ?>">
                                                </div>                                             
                                            </div>
                                            <!-- <div class="mb-3 row">
                                                <div class="col-sm-12">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-12">
                                                    <label for="" class="form-label">Gambar Projek</label>
                                                    <input type="file"
                                                        name="foto">
                                                </div>
                                            </div>
