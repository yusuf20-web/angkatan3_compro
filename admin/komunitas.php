...
$queryKomunitas = mysqli_query($koneksi, "SELECT * FROM komunitas");
...
if (isset($_GET['delete'])) {
    ...
    $deleteKomunitas = mysqli_query($koneksi, "DELETE FROM komunitas  WHERE id ='$id'");
    header("location:komunitas.php?hapus=berhasil");
}
?>
<!DOCTYPE html>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">Data Komunitas</div>
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="tambah-komunitas.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Anggota Komunitas</th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php $no = 1;
                                                while ($row = mysqli_fetch_assoc($queryKomunitas)) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td>
                                                        ...
                                                        <td><?php echo $row['ketua_komunitas'] ?></td>
                                                        <td><?php echo $row['anggota_komunitas'] ?></td>
                                                        <td>
                                                            <a href="tambah-komunitas.php?edit=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">
                                                                <span class="tf-icon bx bx-pencil bx-18px "></span>
                                                            </a>
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')"
                                                                href="komunitas.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
